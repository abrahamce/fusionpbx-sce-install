...
su -c "iptables -A INPUT --source $master_ip --jump ACCEPT"
...
-A INPUT --source ${master_ip} -J ACCEPT
...
-A INPUT -p tcp --dport 5060:5061 -j ACCEPT
-A INPUT -p udp --dport 5060:5061 -j ACCEPT
-A INPUT -p tcp --dport 5080:5081 -j ACCEPT
-A INPUT -p udp --dport 5080:5081 -j ACCEPT
